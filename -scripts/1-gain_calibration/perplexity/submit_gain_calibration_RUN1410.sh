#!/usr/bin/env bash
# ============================================================
# One-time submit script — Gain calibration RUN 1410
# Hardcoded input: /junofs/users/gferrante/TAO/data_analysis/energy_spectrum/charge_merged/CHARGE_RUN1410_merged.root
# ============================================================
set -euo pipefail

RUN=1410
INPUT="/junofs/users/gferrante/TAO/data_analysis/energy_spectrum/charge_merged/CHARGE_RUN1410_merged.root"
OUT_DIR="/junofs/users/gferrante/TAO/data_analysis/energy_spectrum/gain_calibration/RUN1410"
LOG_DIR="/junofs/users/gferrante/TAO/data_analysis/energy_spectrum/gain_calibration/logs/RUN1410"
